...
def _sky130_provenance(source_path: str, rule_id: str) -> RuleProvenance:
    """Build a :class:`RuleProvenance` for an open_pdks-sourced sky130
    width/space rule (issue #788) -- `source_path` is one of this deck's two
    DRC-DSL scripts (``sky130/klayout/sky130.lydrc`` or
    ``sky130/klayout/sky130A_mr.drc``, see the module docstring's own
    citations of each), everything else shared across the whole deck (see
