// Vendored from the real fleet canary repo `2AMLogic/sky130-modexp`
// (`rtl/modexp.v`), commit `1b38ab4f1c5dc5b3396b50fcdf983f8768775e7b`
// (2026-08-24), Apache-2.0 licensed. See `../README.md`'s "Provenance"
// section for the full attribution this file's redistribution requires
// under Apache-2.0 §4, and why this is vendored rather than fetched at run
// time (issue #1329).
//
