...
precheck`/`klt layout-metrics` against machine-generated, macro-scale,
standard-cell layout rather than hand-drawn analog GDS (issue #436, Phase 5
of [Epic #391](https://github.com/2AMLogic/klayout-tools/issues/391)).
