...
#: width/space rules only -- see the module docstring; sg13g2 added by issue
#: #905, Epic #711 Phase 3b, reusing the same width/space-only manifest
#: infra for its own 8-rule starter subset).
