...
gf180mcu's own coverage to its full DRC deck (56 rules as of issue #2369;
46 as of issue #1688; 44 as of issue #1110; 42 when #904 landed) (also
`enclosing`/`separation`/`enclosed`) -- see `generate_golden_deck.py`'s
`ALLOWED_CHECKS` and its own
