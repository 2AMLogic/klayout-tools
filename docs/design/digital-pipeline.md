...
- **Exit criteria (converged)** — all five:
...
D5's three uncheckable concerns — CDC structure, spec traceability,
side-channel behavior — where the review guides are the *only* line of defense
and no tool is proposed.
